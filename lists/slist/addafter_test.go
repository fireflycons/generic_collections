...
func TestAddAfter_LLNode(t *testing.T) {
	...
	var tempItems, headItems, _, tailItems []int
...
func TestAddAfter_LLNode_Negative(t *testing.T) {
	...
	t.Run("Verify Node that already exists in another collection", func(t *testing.T) {
		...
		tempSList.AddItemLast(util.CreateRandInt(&seed))
		require.Panics(t, func() { linkedList.AddItemAfter(tempSList.Last(), util.CreateRandInt(&seed)) })
		initialItems_Tests(t, linkedList, items)
...
func TestAddAfter_LLNode_LLNode_Negative(t *testing.T) {
	...
	t.Run("Verify Node that already exists in another collection", func(t *testing.T) {
		...
		tempSList.AddItemLast(util.CreateRandInt(&seed))
		tempSList.AddItemLast(util.CreateRandInt(&seed))
		require.Panics(t, func() { linkedList.AddNodeAfter(tempSList.Last(), NewNode(util.CreateRandInt(&seed))) })
	...
	t.Run("Verify newNode that already exists in another collection", func(t *testing.T) {
		...
		tempSList.AddItemLast(util.CreateRandInt(&seed))
		tempSList.AddItemLast(util.CreateRandInt(&seed))
		require.Panics(t, func() { linkedList.AddNodeAfter(linkedList.First(), tempSList.Last()) })
